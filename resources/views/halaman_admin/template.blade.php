  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
        ...
        <!--<div class="sidebar-brand-text mx-1"><img src="logosmk.png"></div>-->
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="{{url('halaman_admin/dashboard')}}">
...
Divider -->
 <hr class="sidebar-divider my-0">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="{{url('halaman_pelanggan/pelanggan')}}">
      ...
      <!-- Nav Item - Dashboard -->
      <li class="nav-item">
        <a class="nav-link" href="{{url('halaman_admin/produk/produk')}}">
          <i class="fas fa-fw fa-bars"></i>
          <span>Produk </span></a>
      </li>
      <!-- Divider -->
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Proyek I 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="{{url('logoutadmin')}}">Logout</a>
        </div>
      </div>
    </div>
  </div>
