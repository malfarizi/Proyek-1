...
<div style=" background-image: url('{{asset('img/69.jpg')}}');">
    <div class="container">
		<div class="banner-info">
			...
			<span>Halo {{Session::get('nama_pelanggan')}}</span>
...
Indonesia</p>
		...
		<div class="col-md-3 footer-grid">
			<h3>Akun</h3>
			<ul>
				<li><a href="{{ url('/logoutpelanggan')}}">Logout</a></li>
				<li><a href="{{ url('/halaman_pelanggan/pelanggan/profil_pelanggan')}}">Akun</a></li>
				<li><a href="https://wa.me/6285156082609"><img src="{{asset('img/wa.png')}}" style="width: 50px; height: 50px;"></a></li>
...
<script type='text/javascript' src="js/jquery.mycart.js"></script>
  ...
  $(function () {
   ...
   <script src="{{url('halaman_admin/vendor/datatables/jquery.dataTables.min.js')}}"></script>
  <script src="{{url('halaman_admin/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>

  <!-- Page level custom scripts -->
  <script src="{{url('halaman_admin/js/demo/datatables-demo.js')}}"></script>
